...
export function createWpClient({ wpUrl, wpUser, wpAppPassword }) {
    ...
    return {
         ...
         */
        async listPosts(page = 1, perPage = 100) {
            return apiFetch(`/wp/v2/posts?page=${page}&per_page=${perPage}`);
        },
         ...
         * @returns {Promise<object[]>}
         */
        async listMedia(page = 1, perPage = 100) {
            return apiFetch(`/wp/v2/media?page=${page}&per_page=${perPage}`);
        },
